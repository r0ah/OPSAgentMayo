...
--[[ Health ]]
	...
	L0_0.health_recover_crouch_human			= 6.0	--Health recovery time when sinner is behind cover (1.7)
	L0_0.health_recover_crouch_android			= 6.0	--Health recovery time when accessory is behind cover (1.7)
...
--[[ Walk and jump speed ]]
	L0_0.walk_speed								= 7.0	--Walk speed for both sinner and accessory (5.2) (Ideal: 6.5)
	L0_0.walk_to_run_speed_mag					= 2.0	--Run speed for both sinner and accessory (applies to large weapons) (?) (2.0)
	L0_0.air_speed								= 6		--Ibara cling jump range (6)
	L0_0.thorn_hold_walk_speed					= 7.0	--Walk speed while thorn is attached (2.5) (Ideal: 6.5)
	...
	L0_0.transport_walk_speed					= 6.0	--Walk speed while carrying a citizen (3.3)
	L0_0.transport_run_speed					= 7.5	--Run speed while carrying a citizen (5.5)

--[[ Parts severe (the stronger the weapon the better the severe result) ]]
	L0_0.cutoff_add_input						= 500	--Damage done to the part being cut off (11) (Ideal: 60)
	L0_0.cutoff_add_max							= 800	--Maximum damage done to the part being cut off (55) (Ideal: 100)
	L0_0.cutoff_bodydmg_rate					= 0.7	--Damage done to the abductor integrity while cutting parts (0.7) (Ideal: 0.6)
...
--[[ Weapon severe ]]
	L0_0.soul_melee_cut_off						= 0		--Ibara cost when cutting parts using a melee weapon (?) (45)
	L0_0.soul_knife_cut_off						= 0		--Ibara cost when cutting parts using the combat item knife (?) (45)
...
--[[ Subweapon ]]
	L0_0.virgil_sub_weapon_damage_rate			= 20.5	--Sub-weapon damage rate (0.2)
...
--[[ Field combat item ]]
	L0_0.reappear_bullet_s						= 0		--Time for bullets (small) to reappear again after taking one (180)
	L0_0.reappear_bullet_s_fast					= 2		--(2)
	L0_0.reappear_bullet_l						= 0		--Time for bullets (large) to reappear again after taking one (360)
	L0_0.reappear_bullet_l_fast					= 2		--(2)
	L0_0.reappear_sub_weapon					= 0		--Time for combat items to reappear again after taking one (300)
