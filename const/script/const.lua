...
--[[ Health ]]
	...
	L0_0.health_recover_human					= 0.2	--Health regeneration sinner (0.2)
	L0_0.health_recover_android					= 0.4	--Health regeneration accessory (0.4)
	L0_0.health_recover_crouch_human			= 1.7	--Health recovery time when sinner is behind cover (1.7)
	L0_0.health_recover_crouch_android			= 1.7	--Health recovery time when accessory is behind cover (1.7)
...
--[[ Walk and jump speed ]]
	L0_0.walk_speed								= 5.2	--Walk speed for both sinner and accessory (5.2)
	...
	L0_0.transport_run_speed					= 5.5	--Run speed while carrying a citizen (5.5)

--[[ Parts severe (the stronger the weapon the better the severe result) ]]
	L0_0.cutoff_add_input						= 11	--Damage done to the part being cut off (11)
	L0_0.cutoff_add_max							= 55	--Maximum damage done to the part being cut off (55)
	L0_0.cutoff_bodydmg_rate					= 0.7	--Damage done to the abductor integrity while cutting parts (0.7)
...
--[[ Ibara ]]
	L0_0.soul_natural_recover					= 40	--Ibara bar recovery speed (40)
	L0_0.soul_field_recover						= 2000	--Ibara bar recovery when attached to will'o facilities (2000)
	L0_0.crouching_damage_rate					= 0.7	--(0.7)
	L0_0.thorn_hold_len_coef					= 1.5	--(1.5)
	L0_0.soul_thorn_fire						= 55	--Ibara cost when flinging "it" on normal op (55) 
	L0_0.soul_thorn_fire_vs						= 120	--Ibara cost when flinging "it" on pvp (120)
	L0_0.soul_thorn_charge_idle					= 0		--(0)
	L0_0.soul_thorn_charge_fire					= 0		--(0)
	L0_0.soul_recover_cool_time					= 2		--Ibara recovery time on normal op (2)
	L0_0.soul_recover_cool_time_vs				= 2		--Ibara recovery time on pvp (2)
	L0_0.soul_hold_machine						= 50	--Ibara cost when attached to abductors (50)
	L0_0.soul_hold_human						= 50	--Ibara cost when attached to sinners (50)
	L0_0.soul_hold_object						= 45	--Ibara cost when attached to objects (45)
	L0_0.soul_dive_attack						= 90	--Ibara cost when doing ibara dive attack on normal op (90)
	L0_0.soul_dive_attack_vs					= 230	--Ibarra cost when doing ibara dive attack on pvp (230)
	L0_0.soul_thorn_resuscitate					= 50	--Ibara cost when resurrecting allies (50)
	L0_0.soul_resurrect							= 50	--Ibara cost when resurrecting allies (50)
...
--[[ Subweapon ]]
	L0_0.virgil_sub_weapon_damage_rate			= 0.2	--Sub-weapon damage rate (0.2)
...
--[[ Field combat item ]]
	L0_0.reappear_bullet_s						= 180	--Time for bullets (small) to reappear again after taking one (180)
	L0_0.reappear_bullet_s_fast					= 2		--(2)
	L0_0.reappear_bullet_l						= 360	--Time for bullets (large) to reappear again after taking one (360)
	L0_0.reappear_bullet_l_fast					= 2		--(2)
	L0_0.reappear_sub_weapon					= 300	--Time for combat items to reappear again after taking one (300)
